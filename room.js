import { finishQuestionSpin, getRound, joinPresence, startQuestionSpin, watchEntries, watchPresence, watchQuestions, watchRound } from "./round-service.js?v=20260926-2";
...
function renderSelectionStage() {
  ...
  if (showingQuestions) {
    ...
    renderRace(raceStage, entries, { participantLimit: round?.participantLimit });
  }
}
